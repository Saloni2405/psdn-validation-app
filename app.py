...
# --- STEP 2: READY TO VALIDATE ---
    ...
    st.markdown(f'<div class="pipeline-box"><div><b style="color: #4169E1;">Pipeline:</b><br><span style="font-size: 0.9rem; color: #E0E0E0;">1. Structural Check on </span><br><span style="font-size: 0.9rem; color: #E0E0E0;">2. Accuracy Check on all passing rows only </span></div></div>', unsafe_allow_html=True)
